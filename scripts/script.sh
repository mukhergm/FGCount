...
then
        ...
        echo -e '\033[7mNo input ligand file ID is provided. Input file extension should be ".smi"\033[0m'
			...
			rm arrangeline asp_descriptors.txt bondorder* kk LOGP LPMR1 lst Molecular_Weight MR new_bo output.log physicochemical_descriptors ring_info ring.txt RR temp.con test* tmp*
		fi
	fi	
fi
