...
main(int argc, char *argv[])
{
	...
	while(fgets(str,100,fr)!=NULL)
	{
		...
		if(strncmp(final_string[line],"C",1)==0)
                        {
                                if(strstr(final_string[line],"CC1CC4CC46MR"))
                                {
                                        if(strings_array[f.b-1][0]=='C' && strstr(strings_array[f.b-1],"CC2"))
                                        {
                                                b=strstr(final_string[line],"CC1CC4CC46MR");
                                                if(b)
                                                        fill9(b);
                                        }
                                }
				else if(strstr(final_string[line],"CC4CC1CC46MR"))
                                {
					if(strings_array[f.c-1][0]=='C' && strstr(strings_array[f.c-1],"CC2"))
					{
                                                b=strstr(final_string[line],"CC4CC1CC46MR");
                                                if(b)
                                                        fill9(b);
                                        }
                                }
				else if(strstr(final_string[line],"CC4CC4CC16MR"))
                                {
                                        if(strings_array[f.d-1][0]=='C' && strstr(strings_array[f.d-1],"CC2"))
					{
                                                b=strstr(final_string[line],"CC4CC4CC16MR");
                                                if(b)
                                                        fill8(b);
                                        }
                                }
