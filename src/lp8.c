...
void fill1(char *);
	...
	char str[100], s[100];
		...
		//if(strncmp(s,"ON1OC1", 6)==0 && strstr(s,"EST")==NULL && strlen(s)==6 && strstr(s,"OH1")==NULL && strstr(s,"DST")==NULL && strstr(s,"OCN")==NULL && strstr(s,"DIN")==NULL && strstr(s,"DON")==NULL && strstr(s,"ENE")==NULL && strstr(s,"DNE")==NULL) //Ether; 14.JE
                //        fn3=fn3+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OH1OC1") && strstr(s,"EST")) //Acid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                        fn4=fn4+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OC1OH1") && strstr(s,"EST")) //Acid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                        fn4=fn4+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OH1OC1") && strstr(s,"DST")) //Acid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                        fn4=fn4+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OC1OH1") && strstr(s,"DST")) //Acid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                        fn4=fn4+1;
		//if(strncmp(s,"O", 1)==0 && strstr(s,"OC1OH1") && strstr(s,"EST")) //Acid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                //        fn4=fn4+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OH1") && strstr(s,"OP1")) //phosphoricacid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                        fn4=fn4+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OH1") && strstr(s,"OS1")) //Sulfuricacid-Neutral(OH); 14.δZ/14.QZ/14.UZ
                        fn4=fn4+1;
		if(strncmp(s,"O", 1)==0 && strstr(s,"OC1") && strstr(s,"EST") && strstr(s,"OH1")==NULL && strstr(s,"OO1")==NULL && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strchr(st1,'1') && strchr(st2,'1') && strstr(s,"DST")==NULL && strstr(s,"DIN")==NULL && strstr(s,"DON")==NULL) //Anhydride-O(sp3); 14.δα'
                        fn5=fn5+1;  
		//if(strncmp(s,"O", 1)==0 && strchr(st1,'1') && strchr(st2,'1') && strstr(s,"DST") && strstr(s,"OH1")==NULL && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL) //Anhydride-O(sp3)
                  //      fn5=fn5+1;
		if(strncmp(s,"S", 1)==0 && strstr(s,"SH1") && strstr(s,"EST")==NULL && strchr(s,'2')==NULL) //Thiol; 22.Zα'(!δ!!ε)
                        fn6=fn6+1;
		if(strncmp(s,"S", 1)==0 && strstr(s,"SH1") && strstr(s,"EST")) //Thioacid(SH); 22.δZ/22.εZ
                        fn7=fn7+1;
		if(strncmp(s,"S", 1)==0 && strstr(s,"SC1") && strstr(s,"EST")==NULL && strlen(s)==6 && strstr(s,"SH1")==NULL) //Thioether; 22.α'E
                        fn8=fn8+1;
		...
		if(strncmp(s, "N", 1)==0 && strchr(st1,'2')==NULL && strchr(st1,'3')==NULL && strchr(st1,'4')==NULL &&
				            strchr(st1,'5')==NULL && strchr(st1,'6')==NULL && strchr(st1,'7')==NULL &&  //Amine group; 10.αααα(!J!η!θ)@Rg6/10.ααα(!J!η!θ)@Rg6
		...
		if(strncmp(s, "N", 1)==0 && ((strstr(s,"NO2") && strstr(s,"NO1")) || strstr(s,"NO2NO2")) && strstr(s,"NO2NO1NO1")==NULL && strstr(s,"NO1NO2NO1")==NULL && strstr(s,"NO1NO1NO2")==NULL &&
										       ...
										       strstr(s,"NO2NN1")==NULL && strstr(s,"NN1NO2")==NULL && strstr(s,"NN1NC1NO2")==NULL && strstr(s,"NO2NC1NN1")==NULL) //-NO2 group; 8.KLα''
			f31=f31+1;
		...
		/*if(strncmp(s,"P",1)==0 && ((strlen(s)>=18 && strstr(s,"MR")) || (strlen(s)<=19 && strlen(s)>15 && strstr(s,"POS")) || (strlen(s)<=16 && strlen(s)>13 && strstr(s,"MR")==NULL)))
		{
			if(strstr(s,"PO2")==NULL && strstr(s,"PS2")==NULL && strstr(s,"PF1")==NULL &&
			  strstr(s,"Pl1")==NULL && strstr(s,"PB1")==NULL && strstr(s,"PI1")==NULL && strstr(s,"PS1")==NULL)		//Rest of the P-containing compounds; 18.ααααα
				f44=f44+1;
		...
		if(strncmp(s,"P",1)==0 && ((strlen(s)<=13 && strlen(s)>10 && strstr(s,"MR")) || (strlen(s)<=10 && strlen(s)>=6 && strstr(s,"MR")==NULL)))
		{
			if(strchr(s,'2')==NULL)// && strstr(s,"PC1PC1")==NULL)
				f449=f449+1;												
		}*/															//Trivalent-P-containing-compound; 18.ααα
			...
			//if(strncmp(s,"S",1)==0 && ((strlen(s)<=13 && strlen(s)>=11 && strstr(s,"MR")) || (strlen(s)<=13 && strlen(s)>=11 && strstr(s,"POS")) || (strlen(s)<=10 && strlen(s)>=8 && strstr(s,"MR")==NULL && strstr(s,"C2S")==NULL)))   //Rest of the tricoordinated-S-containing compounds which do not contains SO2 moiety; 22.ααα(!K)
			if(strncmp(s,"S",1)==0 && strstr(s,"POS"))   //Rest of the tricoordinated-S-containing compounds which do not contains SO2 moiety; 22.ααα(!K)
			{
			...
			if(strncmp(s,"C", 1)==0)
			{
				...
				if(strstr(s,"TMe"))  //-CH group; 4.Z	
                                f54=f54+1;
				if(strstr(s,"QMe"))  //qMe group; 4.α'α'α'α'
                                f55=f55+1;
			}
			...
			if(strncmp(s,"N",1)==0 && strstr(s,"NN2NN1"))							//Azide-type-reactive; 7.G'J
                                f67=f67+1;
			if(strncmp(s,"S",1)==0 && strstr(s,"SO2") && strlen(s)==9)					//Sulfoxide; 22.Kαα (Its ring part is there at f475)
				f68=f68+1;
			...
			if(strncmp(s,"N",1)==0 && strstr(s,"NO2") && strstr(s,"NO1")==NULL && strstr(s,"NO2NO2")==NULL &&
			   ...
			   strstr(s,"NO2NC1NN1")==NULL && strstr(s,"NN1NC1NO2")==NULL)	  				//Nitroso group; 8.Kα
				f71=f71+1;
			...
			if(strncmp(s,"P",1)==0 && ((strlen(s)>=18 && strstr(s,"MR")) || (strlen(s)<=19 && strlen(s)>15 && strstr(s,"POS")) || (strlen(s)<=16 && strlen(s)>13 && strstr(s,"MR")==NULL)))
                	{
                        if(strstr(s,"PO2")==NULL && strstr(s,"PS2")==NULL && strstr(s,"PF1")==NULL &&
                          strstr(s,"Pl1")==NULL && strstr(s,"PB1")==NULL && strstr(s,"PI1")==NULL && strstr(s,"PS1")==NULL && strlen(s)>10)     //Rest of the P-containing compounds; 18.ααααα
                                f75=f75+1;
                        if(strstr(s,"PF1") || strstr(s,"Pl1") || strstr(s,"PB1") || strstr(s,"PI1") || strstr(s,"PS1"))                 //Rest of the P-containing compounds; 18.X'
                                f75=f75+1;
                	}
			...
			{
				if(strstr(s,"5MR")==NULL && strstr(s,"NN4")==NULL && strstr(s,"NN5")==NULL && strstr(s,"NN6")==NULL) //N(Aromatic)-6-member-ring; 11.Dω(!I)@R6
				f85=f85+1;
				if(strstr(s,"5MR") && strstr(s,"NN4")==NULL && (strstr(s,"NH1") || strstr(s,"NS1") || strstr(s,"NC1") || strstr(s,"NO1") || strstr(s,"NN1") || strstr(s,"NP1") || strstr(s,"NF1") || strstr(s,"NB1")|| strstr(s,"NI1") || strstr(s,"Nl1"))) //Pyrrole nitrogen; 11.Dωα(!I)@R5
				f86=f86+1;
				if((strstr(s,"NN4") || strstr(s,"NN5") || strstr(s,"NN6")) && strstr(s,"5MR")==NULL && strlen(s)<10)	//Pyridazine-nitrogen; 11.DI@R6
				f87=f87+1;	
				if(strstr(s,"5MR") && strstr(s,"6MR")==NULL && strchr(s,'1')==NULL && strchr(s,'2')==NULL)   //Imidazole-nitrogen; 11.Dω@R5; strstr(s,"NO4")==NULL and strstr(s,"NS4")==NULL was deleted on 19.10.2022
					f88=f88+1;
			}
			if(strncmp(s,"N",1)==0)
			{
			...
			if(strncmp(s,"C",1)==0 && strstr(s,"CC2") && strstr(s,"CJO")==NULL && strstr(s,"CJC")==NULL && 
						  ...
						  strstr(s,"CN1")==NULL && strstr(s,"CS1")==NULL && strstr(s,"CJN")==NULL &&	//C=C; 2.αα(!L!J!U!β!γ!δ!ε!ω)
						  strstr(s,"3MR")==NULL &&
						  strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL &&
			...
			if(strncmp(s,"C",1)==0 && (strstr(s,"CC4") || strstr(s,"CC5") || strstr(s,"CC8") ||
						   strstr(s,"CC9") || strstr(s,"CN4") || strstr(s,"CN5") ||
					           strstr(s,"CN8") || strstr(s,"CN9") || strstr(s,"CO4") ||             //Benzene-C;  5.ωωα
			...
			if(strncmp(s,"C",1)==0 && (strstr(s,"CC4") || strstr(s,"CC5") || strstr(s,"CC8") ||
                                                   ...
                                                   strstr(s,"CS9")) && strlen(s)==15)
			{
				if(strchr(st1,'1')==NULL && strchr(st1,'2')==NULL && strchr(st1,'3')==NULL && strchr(st2,'1')==NULL && strchr(st2,'2')==NULL && strchr(st2,'3')==NULL && strchr(st3,'1')==NULL && strchr(st3,'2')==NULL && strchr(st3,'3')==NULL)  //5.ωωω@R6_6/5.ωωω@R6_5/5.ωωω@R5_5
                                	f415=f415+1;
			}
			...
			if(strncmp(s,"O",1)==0 && strstr(s,"OO1") && strstr(s,"EST"))					//14.δL
				 f448=f448+1;

			if(strncmp(s,"N",1)==0 && strstr(s,"NC4") && strlen(s)==15 && strstr(s,"6MR6MR"))		//Anthracene-N; 11.Dωω@R6_6, e.g.; Quinolizinium
                                f100=f100+1;
			if(strncmp(s,"C",1)==0 && strstr(s,"CN6") && strlen(s)==12 && strstr(s,"6MR6MR"))              //Anthracene-C
                                f100=f100+1;	
			if(strncmp(s,"C",1)==0 && strstr(s,"CC4CC4CC4") && strlen(s)==18 && strstr(s,"6MR6MR6MR"))    //Phenalene-C; 5.ωωω@R6_6_6
                                f101=f101+1;
			if(strncmp(s,"N",1)==0 && strstr(s,"NO4") && strlen(s)==9)					//Oxadiazole; 11.Mω
				f102=f102+1;	
			if(strncmp(s,"N",1)==0 && strstr(s,"NS4") && strlen(s)==9)                                     //Thiadiazole; 11.Tω
                        	f103=f103+1;
			...
			if(strncmp(s,"C", 1)==0 && strstr(s,"CNJ")==NULL)
			{
				...
				if(strstr(s,"CO2") && strstr(s,"CS1"))
                                {
                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //C(=O)(S)-3/4-membered; 2.δUα@R3/2.δUα@R4
                                                f206=f206+1;
                                        if(strstr(s,"5MR"))                                                             //C(=O)(S)-5-membered; 2.δUα@R5
                                                f207=f207+1;
                                        if(strstr(s,"6MR"))                                                             //C(=O)(S)-6-membered; 2.δUα@R6
                                                f208=f208+1;
                                        if(strstr(s,"7MR"))                                                             //C(=O)(S)-7-membered; 2.δUα@R7
                                                f209=f209+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strstr(s,"7MR")==NULL)
						f210=f210+1;								//Rest-of-the-C(=O)(S)-groups; 2.δUα@Rg7
                                }
				...
				/*if(strstr(s,"CC2") && strstr(s,"CO1") && strstr(s,"ENL"))				//Enol-tautomer; 2.B'ψ
						f127=f127+1;
				if(strstr(s,"CN2") && strstr(s,"CO1") && strstr(s,"ELN"))				//C(=N)OH; 2.G'ψ
                                                f128=f128+1;*/

				//if(strstr(s,"CS2CN1CN1") || strstr(s,"CN1CS2CN1") || strstr(s,"CN1CN1CS2"))		//Thiourea
				//		f129=f129+1;
			}
			if(strncmp(s,"O", 1)==0 && strstr(s,"OC1") && strstr(s,"OH1") && strstr(s,"ENL"))		//14.βZ
                                        f127=f127+1;
			if(strncmp(s,"O", 1)==0 && strstr(s,"OC1") && strstr(s,"OH1") && strstr(s,"ELN"))		//14.γZ
                                        f128=f128+1;
			...
			if(strncmp(s,"C", 1)==0 && strstr(s,"CNJ"))
				...
				{
					if(strstr(s,"4MR") || strstr(s,"3MR"))						//C=C-C=O-in-3/4-member-ring; 2.B'δ@R3/2.B'γ@R3/2.B'ε@R3/2.B'δ@R4/2.B'γ@R4/2.B'ε@R4
						f130=f130+1;
					if(strstr(s,"5MR"))								//C=C-C=O-in-5-member-ring; 2.B'δ@R5/2.B'γ@R5/2.B'ε@R5
						f131=f131+1;
					if(strstr(s,"6MR"))								//C=C-C=O-in-6-member-ring; 2.B'δ@R6/2.B'γ@R6/2.B'ε@R6
                                                f132=f132+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f90=f90+1;								//C=C-C=O-Rest; 2.B'δ@Rg6/2.B'γ@Rg6/2.B'ε@Rg6
				}
				if(strstr(s,"CJC") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"4MR") || strstr(s,"3MR"))						//C=C-C=C-in-3/4-member-ring; 2.B'β@R3/2.B'β@R4
                                                f133=f133+1;
                                        if(strstr(s,"5MR"))								//C=C-C=C-in-5-member-ring; 2.B'β@R5
                                                f134=f134+1;
                                        if(strstr(s,"6MR"))								//C=C-C=C-in-6-member-ring; 2.B'β@R6
                                                f135=f135+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f91=f91+1;								//C=C-C=C-Rest; 2.B'β@Rg6
                                }
				if(strstr(s,"CJB") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"4MR") || strstr(s,"3MR"))						//Phenylvinyl-3/4-member-ring; 2.B'ω@R3/2.B'ω@R4
                                                f136=f136+1;
                                        if(strstr(s,"5MR"))								//Phenylvinyl-5-member-ring; 2.B'ω@R5
                                                f137=f137+1;
                                        if(strstr(s,"6MR"))								//Phenylvinyl-6-member-ring; 2.B'ω@R6
                                                f138=f138+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f92=f92+1;								//Phenylvinyl-Rest; 2.B'ω@Rg6
                                }

				if(strstr(s,"NJO") && strncmp(s,"N",1)==0)						
                                {
					if(strstr(s,"5MR"))								//N=C-C=O-5-member-ring; 8.B'δ@R5
						f139=f139+1;
					if(strstr(s,"6MR"))								//N=C-C=O-6-member-ring; 8.B'δ@R6
                                                f140=f140+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//N=C-C=O-3/4-member-ring; 8.B'δ@R3/8.B'δ@R4
						f377=f377+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f93=f93+1;								//N=C-C=O-Rest; 8.B'δ@Rg6
				}

				if(strstr(s,"NJC") && strncmp(s,"N",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //N=C-C=C-5-member-ring; 8.B'β@R5
                                                f141=f141+1;
                                        if(strstr(s,"6MR"))                                                             //N=C-C=C-6-member-ring; 8.B'β@R6
                                                f142=f142+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //N=C-C=C-3/4-member-ring; 8.B'β@R3/8.B'β@R4
                                                f378=f378+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f94=f94+1;								//N=C-C=C-Rest; 8.B'β@Rg6
                                }
				
				if(strstr(s,"NJN") && strncmp(s,"N",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //N=C-C=N-5-member-ring; 8.B'γ@R5
                                                f143=f143+1;
                                        if(strstr(s,"6MR"))                                                             //N=C-C=N-6-member-ring; 8.B'γ@R6
                                                f144=f144+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //N=C-C=N-3/4-member-ring; 8.B'γ@R3/8.B'γ@R4
                                                f379=f379+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f95=f95+1;								//N=C-C=N-Rest; 8.B'γ@Rg6
                                }
				if(strncmp(s,"N",1)==0 && strstr(s,"NJS"))  //It was CNJ
				{
					if(strstr(s,"5MR"))								//N=C-C=S-5-member-ring; 8.B'ε@R5
						f145=f145+1;
					if(strstr(s,"6MR"))								//N=C-C=S-6-member-ring; 8.B'ε@R6
                                                f146=f146+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //N=C-C=S-3/4-member-ring; 8.B'ε@R3/8.B'ε@R4
                                                f380=f380+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f147=f147+1;								//N=C-C=S-rest; 8.B'ε@Rg6
				}
				if(strncmp(s,"N",1)==0 && strstr(s,"NJB")) //It was CNC
                                {
                                        if(strstr(s,"5MR"))								//N=C-Ph-5-member-ring; 8.B'ω@R5
                                                f148=f148+1;
                                        if(strstr(s,"6MR"))								//N=C-Ph-6-member-ring; 8.B'ω@R6
                                                f149=f149+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //N=C-Ph-3/4-member-ring; 8.B'ω@R3/8.B'ω@R4
                                                f381=f381+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f150=f150+1;								//N=C-Ph-rest; 8.B'ω@Rg6
                                }
				...
				{
					if(strstr(s,"5MR"))								//C(=S)-C=S-5-member-ring; 2.Rε@R5
						f252=f252+1;
					if(strstr(s,"6MR"))								//C(=S)-C=S-6-member-ring; 2.Rε@R6
						f253=f253+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=S)-C=S-3/4-member-ring; 2.Rε@R3/2.Rε@R4
						f382=f382+1;
					if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
						f352=f352+1;								//C(=S)-C=S-Rest; 2.Rε@Rg6
				}
				if(strstr(s,"CSB") && strncmp(s,"C",1)==0)
				{
					if(strstr(s,"5MR"))                                                             //C(=S)-Ph-5-member-ring; 2.Rω@R5
                                                f353=f353+1;
                                        if(strstr(s,"6MR"))                                                             //C(=S)-Ph-6-member-ring; 2.Rω@R6
                                                f354=f354+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //C(=S)-Ph-3/4-member-ring; 2.Rω@R3/2.Rω@R4
                                                f383=f383+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f355=f355+1;                                                            //C(=S)-Ph-Rest; 2.Rω@Rg6
                                }
				if(strstr(s,"CNO") && strncmp(s,"C",1)==0)
                                {
					if(strstr(s,"5MR"))                                                             //C(=N)-C=O-5-member-ring; 2.G'δ@R5
                                                f356=f356+1;
                                        if(strstr(s,"6MR"))                                                             //C(=N)-C=O-6-member-ring; 2.G'δ@R6
                                                f357=f357+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=N)-C=O-3/4-member-ring; 2.G'δ@R3/2.G'δ@R5
						f384=f384+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f358=f358+1;                                                            //C(=N)-C=O-Rest; 2.G'δ@Rg6
                                }
				if(strstr(s,"CNN") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //C(=N)-C=N-5-member-ring; 2.G'γ@R5
                                                f359=f359+1;
                                        if(strstr(s,"6MR"))                                                             //C(=N)-C=N-6-member-ring;2.G'γ@R6
                                                f360=f360+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=N)-C=N-3/4-member-ring; 2.G'γ@R3/2.G'γ@R4
						f385=f385+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f361=f361+1;                                                            //C(=N)-C=N-Rest; 2.G'γ@Rg6
                                }
				if(strstr(s,"CNS") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //C(=N)-C=S-5-member-ring; 2.G'ε@R5
                                                f362=f362+1;
                                        if(strstr(s,"6MR"))                                                             //C(=N)-C=S-6-member-ring; 2.G'ε@R6
                                                f363=f363+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=N)-C=S-3/4-member-ring; 2.G'ε@R3/2.G'ε@R4
						f386=f386+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f364=f364+1;                                                            //C(=N)-C=S-Rest; 2.G'ε@Rg6
				}
				if(strstr(s,"CNB") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //C(=N)-Ph-5-member-ring; 2.G'ω@R5
                                                f365=f365+1;
                                        if(strstr(s,"6MR"))                                                             //C(=N)-Ph-6-member-ring; 2.G'ω@R6
                                                f366=f366+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=N)-Ph-3/4-member-ring; 2.G'ω@R3/2.G'ω@R4
						f387=f387+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f367=f367+1;                                                            //C(=N)-Ph-Rest; 2.G'ω@Rg6
                                }
				if(strstr(s,"COO") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //C(=O)-C=O-5-member-ring; 2.Kδ@R5
                                                f368=f368+1;
                                        if(strstr(s,"6MR"))                                                             //C(=O)-C=O-6-member-ring; 2.Kδ@R6
                                                f369=f369+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=O)-C=O-3/4-member-ring; 2.Kδ@R3/2.Kδ@R4
						f388=f388+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f370=f370+1;                                                            //C(=O)-C=O-Rest; 2.Kδ@Rg6
                                }
				if(strstr(s,"COS") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //C(=O)-C=S-5-member-ring; 2.Kε@R5
                                                f371=f371+1;
                                        if(strstr(s,"6MR"))                                                             //C(=O)-C=S-6-member-ring; 2.Kε@R6
                                                f372=f372+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //C(=O)-C=S-3/4-member-ring; 2.Kε@R3/2.Kε@R4
						f389=f389+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f373=f373+1;                                                            //C(=O)-C=S-Rest; 2.Kε@Rg6
                                }
				if(strstr(s,"COB") && strncmp(s,"C",1)==0)
                                {
                                        if(strstr(s,"5MR"))                                                             //C(=O)-Ph-5-member-ring; 2.Kω@R5
                                                f374=f374+1;
                                        if(strstr(s,"6MR"))                                                             //C(=O)-Ph-6-member-ring; 2.Kω@R6
                                                f375=f375+1;
					if(strstr(s,"3MR") || strstr(s,"4MR"))						//C(=O)-Ph-3/4-member-ring; 2.Kω@R3/2.Kω@R4
						f390=f390+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL)
                                                f376=f376+1;                                                            //C(=O)-Ph-Rest; 2.Kω@Rg6
                                }
			...
			if(strncmp(s,"N", 1)==0 && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strstr(s,"7MR")==NULL && strstr(s,"NH1") && strlen(s)>=9)
			{
				...
				{
					if(strstr(s,"NYL"))								//Amine(NH)-Conjugation-One-Vinyl; 10.Zβα@Rg7
						f151=f151+1;
					if(strstr(s,"DYL"))								//Amine(NH)-Conjugation-Two-Vinyl; 10.Zββ@Rg7
                                        	f152=f152+1;				
					if(strstr(s,"AMD"))								//Amide(NH); 10.Zδα@Rg7
						f159=f159+1;								
					if(strstr(s,"DAM"))								//Di-Amide(NH); 10.Zδδ@Rg7
                                        	f160=f160+1;
					if(strstr(s,"MTD"))								//Thioamide(NH); 10.Zεα
                                        	f161=f161+1;
					if(strstr(s,"DTD"))                                                             //Di-Thioamide(NH); 10.εεZ@Rg7
                                        	f340=f340+1;
					if(strstr(s,"UER"))                                                             //Amidine(NH); 10.γαZ@Rg7
                                        	f341=f341+1;
					if(strstr(s,"DUR"))                                                             //Di-Amidine(NH); 10.γγZ@Rg7
                                        	f342=f342+1;
				}
			}
			if(strncmp(s,"N", 1)==0 && strstr(s,"NH1") && strlen(s)>=15)
                        {
				if(strstr(s,"NYLAMD") || strstr(s,"AMDNYL"))						//Amine(NH)-Conjugation-Amide-Vinyl; 10.Zδβ
					f153=f153+1;
				if(strstr(s,"NYLMTD") || strstr(s,"MTDNYL"))						//Amine(NH)-Conjugation-Thioamide-Vinyl; 10.Zβε
					f154=f154+1;
				if(strstr(s,"NYLUER") || strstr(s,"UERNYL"))						//Amine(NH)-Conjugation-Imine-Vinyl; 10.Zβγ
					f155=f155+1;
				if(strstr(s,"AMDMTD") || strstr(s,"MTDAMD"))						//Amine(NH)-Conjugation-Amide-Thioamide; 10.Zδε
					f156=f156+1;
				if(strstr(s,"AMDUER") || strstr(s,"UERAMD"))                                            //Amine(NH)-Conjugation-Amide-Imine; 10.Zδγ
					f157=f157+1;
				if(strstr(s,"MTDUER") || strstr(s,"UERMTD"))						//Amine(NH)-Conjugation-Thioamide-Imine; 10.Zγε
					f158=f158+1;
			}
			/*if(strstr(s,"CC2") && strstr(s,"CO1") && strstr(s,"ENL")==NULL)                         //(C)O-C-C=C; 2.B'L(!ψ)
                                     f162=f162+1;
                        if(strstr(s,"CN2") && strstr(s,"CO1") && strstr(s,"ELN")==NULL)                         //(C)O-C-C=N; 2.G'L(!ψ)
                                     f163=f163+1;*/
			...
			if(strncmp(s,"S",1)==0)
			{
				if(strstr(s,"SO2") && strlen(s)==12 && strstr(s,"MR")) 				//Sulfoxide; 22.Kαα@R
					f475=f475+1;
				//if(strstr(s,"SO2") && strlen(s)==9 && strstr(s,"MR")==NULL)			//Sulfoxide; 22.Kαα
                                //        f475=f475+1;
			...
			//	f166=f166+1;
                        if(strncmp(s,"N",1)==0 && strstr(s,"5MR")==NULL && (strstr(s,"NC4NC4NO2") || strstr(s,"NC4NO2NC4") || strstr(s,"NO2NC4NC4")))	//N-oxide; 11.ωωL@(!R5)
				f167=f167+1;
			if(strncmp(s,"N",1)==0 && strstr(s,"5MR")==NULL && (strstr(s,"NC4NC4NO1") || strstr(s,"NC4NO1NC4") || strstr(s,"NO1NC4NC4")))     //N-oxide; 11.ωωL@(!R5)
                                f167=f167+1;
			...
			if(strncmp(s,"N", 1)==0) 
			{
			   ...
			   strchr(st1,'2')==NULL && strchr(st2,'2')==NULL && strchr(st3,'2')==NULL && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strchr(st3,'4')==NULL && strstr(s,"P=O")==NULL)
				{
					if(strstr(s,"3MR"))										//Amine-3-member-ring; 10.αααα(!J!η!θ)@R3/10.ααα(!J!η!θ)@R3
						f170=f170+1;
					if(strstr(s,"4MR"))                          		                                        //Amine-4-member-ring; 10.αααα(!J!η!θ)@R4/10.ααα(!J!η!θ)@R4
                                		f171=f171+1;
					if(strstr(s,"5MR"))                                                                             //Amine-5-member-ring; 10.αααα(!J!η!θ)@R5/10.ααα(!J!η!θ)@R5
                                	        f175=f175+1;
					if(strstr(s,"6MR"))                                                                             //Amine-6-member-ring; 10.αααα(!J!η!θ)@R6/10.ααα(!J!η!θ)@R6
                                	        f409=f409+1;
				}
			}
			if(strncmp(s,"O", 1)==0 && strstr(s,"3MR") && strstr(s,"EST")==NULL && strstr(s,"DST")==NULL && strstr(s,"OCN")==NULL && strstr(s,"ODD")==NULL && strstr(s,"OTD")==NULL && strstr(s,"DIN")==NULL && strstr(s,"DON")==NULL && strstr(s,"ENE")==NULL && strstr(s,"DNE")==NULL && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strstr(s,"S=O")==NULL && strstr(s,"P=O")==NULL)     //Epoxide-3-member-ring;  14.α'α'@R3
                                f172=f172+1;
                        if(strncmp(s,"O", 1)==0 && strstr(s,"4MR") && strstr(s,"EST")==NULL && strstr(s,"DST")==NULL && strstr(s,"OCN")==NULL && strstr(s,"ODD")==NULL && strstr(s,"OTD")==NULL && strstr(s,"DIN")==NULL && strstr(s,"DON")==NULL && strstr(s,"ENE")==NULL && strstr(s,"DNE")==NULL && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strstr(s,"S=O")==NULL && strstr(s,"P=O")==NULL)     //Epoxide-4-member-ring; 14.α'α'@R4
                                f173=f173+1;
			if(strncmp(s,"O", 1)==0 && strstr(s,"5MR") && strstr(s,"EST")==NULL && strstr(s,"DST")==NULL && strstr(s,"OCN")==NULL && strstr(s,"ODD")==NULL && strstr(s,"OTD")==NULL && strstr(s,"DIN")==NULL && strstr(s,"DON")==NULL && strstr(s,"ENE")==NULL && strstr(s,"DNE")==NULL && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strstr(s,"S=O")==NULL && strstr(s,"P=O")==NULL)    //Epoxide-5-member-ring; 14.α'α'@R5
                                f391=f391+1;
			if(strncmp(s,"O", 1)==0 && strstr(s,"6MR") && strstr(s,"EST")==NULL && strstr(s,"DST")==NULL && strstr(s,"OCN")==NULL && strstr(s,"ODD")==NULL && strstr(s,"OTD")==NULL && strstr(s,"DIN")==NULL && strstr(s,"DON")==NULL && strstr(s,"ENE")==NULL && strstr(s,"DNE")==NULL && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strstr(s,"S=O")==NULL && strstr(s,"P=O")==NULL)     //Epoxide-6-member-ring; 14.α'α'@R6
                                f392=f392+1;
			if(strncmp(s,"O", 1)==0)
			{
				if(strstr(s,"EST") && strstr(s, "DON")==NULL)		//DON condition was added on 12.15.21
				{
					if(strstr(s,"3MR"))				//Ester-O-3-member-ring; 14.δE@R3/14.δZ@R3
						f393=f393+1;
					if(strstr(s,"4MR"))				//Ester-O-4-member-ring; 14.δE@R4/14.δZ@R4
                                                f394=f394+1;
					if(strstr(s,"5MR"))				//Ester-O-5-member-ring; 14.δE@R5/14.δZ@R5
                                                f395=f395+1;
					if(strstr(s,"6MR"))				//Ester-O-6-member-ring; 14.δE@R6/14.δZ@R6
                                                f396=f396+1;
				}
				if(strstr(s,"DST"))
                                {
                                        if(strstr(s,"3MR"))				//Di-Ester-O-3-member-ring; 14.δδ@R3
                                                f397=f397+1;
                                        if(strstr(s,"4MR"))				//Di-Ester-O-4-member-ring; 14.δδ@R4
                                                f398=f398+1;
                                        if(strstr(s,"5MR"))				//Di-Ester-O-5-member-ring; 14.δδ@R5
                                                f399=f399+1;
                                        if(strstr(s,"6MR"))				//Di-Ester-O-6-member-ring; 14.δδ@R6
                                                f400=f400+1;
                                }
				if(strstr(s,"OCN") && strstr(s, "DON")==NULL)		//DON condition was added on 12.15.21
                                {
                                        if(strstr(s,"3MR"))				//(C=N)Ester-O-3-member-ring; 14.γE@R3/14.γZ@R3
                                                f401=f401+1;
                                        if(strstr(s,"4MR"))				//(C=N)Ester-O-4-member-ring; 14.γE@R4/14.γZ@R4		
                                                f402=f402+1;
                                        if(strstr(s,"5MR"))				//(C=N)Ester-O-5-member-ring; 14.γE@R5/14.γZ@R5
                                                f403=f403+1;
                                        if(strstr(s,"6MR"))				//(C=N)Ester-O-6-member-ring; 14.γE@R6/14.γZ@R6
                                                f404=f404+1;
                                }
				if(strstr(s,"DIN"))
                                {
                                        if(strstr(s,"3MR"))				//(C=N)2Ester-O-3-member-ring; 14.γγ@R3
                                                f405=f405+1;
                                        if(strstr(s,"4MR"))				//(C=N)2Ester-O-4-member-ring; 14.γγ@R4
                                                f406=f406+1;
                                        if(strstr(s,"5MR"))				//(C=N)2Ester-O-5-member-ring; 14.γγ@R5
                                                f407=f407+1;
                                        if(strstr(s,"6MR"))				//(C=N)2Ester-O-6-member-ring; 14.γγ@R6
                                                f408=f408+1;
                                }
				if(strstr(s,"ENE"))
                                {
                                        if(strstr(s,"3MR"))                             //-O-C=C-in-3-member-ring; 14.βE@R3 
                                                f440=f440+1;
                                        if(strstr(s,"4MR"))                             //-O-C=C-in-4-member-ring; 14.βE@R4
                                                f441=f441+1;
                                        if(strstr(s,"5MR"))                             //-O-C=C-in-5-member-ring; 14.βE@R5
                                                f442=f442+1;
                                        if(strstr(s,"6MR"))                             //-O-C=C-in-6-member-ring; 14.βE@R6
                                                f443=f443+1;
                                }
				if(strstr(s,"DNE"))
                                {
                                        if(strstr(s,"3MR"))                             //C=C-O-C=C-in-3-member-ring; 14.ββ@R3
                                                f444=f444+1;
                                        if(strstr(s,"4MR"))                             //C=C-O-C=C-in-4-member-ring; 14.ββ@R4
                                                f445=f445+1;
                                        if(strstr(s,"5MR"))                             //C=C-O-C=C-in-5-member-ring; 14.ββ@R5
                                                f446=f446+1;
                                        if(strstr(s,"6MR"))                             //C=C-O-C=C-in-6-member-ring; 14.ββ@R6
                                                f447=f447+1;
                                }
			}
			...
			{
				if(strncmp(s,"S", 1)==0 && strstr(s,"3MR") && strstr(s,"EST")==NULL)                                    //Thioether(S)-3-member-ring; 22.α'α'@R3
                                	f78=f78+1;
                        	if(strncmp(s,"S", 1)==0 && strstr(s,"4MR") && strstr(s,"EST")==NULL)                                    //Thioether(S)-4-member-ring; 22.α'α'@R4
                                	f79=f79+1;
				if(strncmp(s,"S", 1)==0 && strstr(s,"5MR") && strstr(s,"EST")==NULL)                                    //Thioether(S)-5-member-ring; 22.α'α'@R5
                                        f104=f104+1;
				if(strncmp(s,"S", 1)==0 && strstr(s,"6MR") && strstr(s,"EST")==NULL)                                    //Thioether(S)-6-member-ring; 22.α'α'@R6
                                        f174=f174+1;
			}
			//THis part is replaced by amine containing functional group...
			/*	if(strncmp(s,"S", 1)==0 && strstr(s,"5MR") && strstr(s,"EST")==NULL && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL)   //Thioether(S)-5-and-higher-member-ring; 22.α'α'(!δ!ε)@R5
                                	f409=f409+1;
				if(strncmp(s,"S", 1)==0 && strstr(s,"6MR") && strstr(s,"EST")==NULL && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL)   //Thioether(S)-5-and-higher-member-ring; 22.α'α'(!δ!ε)@R6
                               		f409=f409+1;
				if(strncmp(s,"S", 1)==0 && strstr(s,"7MR") && strstr(s,"EST")==NULL && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL)   //Thioether(S)-5-and-higher-member-ring; 22.α'α'(!δ!ε)@R7
                                	f409=f409+1;
				if(strncmp(s,"S", 1)==0 && strstr(s,"8MR") && strstr(s,"EST")==NULL && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL)   //Thioether(S)-5-and-higher-member-ring; 22.α'α'(!δ!ε)@R8
                                	f409=f409+1;
			}*/
			 ...
			 if(strncmp(s,"C", 1)==0 && strstr(s,"CS2") && strstr(s,"CNJ")==NULL)   //CNJ condition was added on 12.19.21
			 {
				...
				if(strstr(s,"CS1"))
                                {
                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //CS2()(S)-3/4-member-ring; 2.RUα@R3/2.RUα@R4
                                                f191=f191+1;
                                        if(strstr(s,"5MR"))                                                             //CS2()(S)-5-member-ring; 2.RUα@R5
                                                f192=f192+1;
                                        if(strstr(s,"6MR"))                                                             //CS2()(S)-6-member-ring; 2.RUα@R6
                                                f193=f193+1;
                                        if(strstr(s,"7MR"))                                                             //CS2()(S)-7-member-ring; 2.RUα@R7
                                                f194=f194+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strstr(s,"7MR")==NULL)
                                                f195=f195+1;								//Rest-ot-the-CS2()(S)-groups; 2.RUα@Rg7
				}
				...
				if(strstr(s,"CS2CC1CC1") || strstr(s,"CC1CS2CC1") || strstr(s,"CC1CC1CS2"))
				{
			 	...
			 	if(strncmp(s,"C", 1)==0 && strstr(s,"CN2"))
			 	{
					...
					if(strstr(s,"CS1") && strstr(s,"CNJ")==NULL)
                        	        {
                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //CN2(S)()-3/4-member-ring; 2.G'Uα@R3/2.G'Uα@R4
                                                f231=f231+1;
                                        if(strstr(s,"5MR"))                                                             //CN2(S)()-5-member-ring; 2.G'Uα@R5
                                                f232=f232+1;
                                        if(strstr(s,"6MR"))                                                             //CN2(S)()-6-member-ring; 2.G'Uα@R6
                                                f233=f233+1;
                                        if(strstr(s,"7MR"))                                                             //CN2(S)()-7-member-ring; 2.G'Uα@R7
                                                f234=f234+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strstr(s,"7MR")==NULL)
                                                f235=f235+1;								//Rest-ot-the-CN2(S)()-groups; 2.G'Uα@Rg7
					}
				...
				if(strncmp(s,"C", 1)==0 && strstr(s,"CC2") && strstr(s,"CNJ")==NULL)  //CNJ condition was added on 12.19.21
					...
					if(strstr(s,"CS1"))
                                        {
                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                                          //CC2(S)()-3/4-member-ring; 2.B'Uα@R3/2.B'Uα@R4
                                                f269=f269+1;
                                        if(strstr(s,"5MR"))                                                             //CC2(S)()-5-member-ring; 2.B'Uα@R5
                                                f270=f270+1;
                                        if(strstr(s,"6MR"))                                                             //CC2(S)()-6-member-ring; 2.B'Uα@R6
                                                f271=f271+1;
                                        if(strstr(s,"7MR"))                                                             //CC2(S)()-7-member-ring; 2.B'Uα@R7
                                                f272=f272+1;
                                        if(strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strstr(s,"7MR")==NULL)
                                                f273=f273+1;                                                            //Rest-ot-the-CC2(S)()-groups; 2.B'Uα@Rg7
                                        }
				...
				if(strncmp(s,"N",1)==0)
				{
					if(strstr(s,"NH1"))
					{
						...
						{
							if(strstr(s,"3MR") || strstr(s,"4MR"))				//Amide(NH)-3/4-member-ring; 10.δZα@R3/10.δZα@R4
								f292=f292+1;
							if(strstr(s,"5MR"))						//Amide(NH)-5-member-ring; 10.δZα@R5
								f293=f293+1;
							if(strstr(s,"6MR"))						//Amide(NH)-6-member-ring; 10.δZα@R6
                                                                f294=f294+1;
							if(strstr(s,"7MR"))						//Amide(NH)-7-member-ring; 10.δZα@R7
                                                                f295=f295+1;
						}
						if(strstr(s,"DAM"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Di-Amide(NH)-3/4-member-ring; 10.δδZ@R3/10.δδZ@R4
                                                                f296=f296+1;
                                                        if(strstr(s,"5MR"))						//Di-Amide(NH)-5-member-ring; 10.δδZ@R5
                                                                f297=f297+1;
                                                        if(strstr(s,"6MR"))						//Di-Amide(NH)-6-member-ring; 10.δδZ@R6
                                                                f298=f298+1;
                                                        if(strstr(s,"7MR"))						//Di-Amide(NH)-7-member-ring; 10.δδZ@R7
                                                                f299=f299+1;
                                                }
						if(strstr(s,"MTD") && strstr(s,"AMDMTD")==NULL && strstr(s,"MTDAMD")==NULL && strstr(s,"MTDNYL")==NULL && strstr(s,"NYLMTD")==NULL && strstr(s,"MTDUER")==NULL && strstr(s,"UERMTD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Thioamide(NH)-3/4-member-ring; 10.εZα@R3/10.εZα@R4
                                                                f300=f300+1;
                                                        if(strstr(s,"5MR"))						//Thioamide(NH)-5-member-ring; 10.εZα@R5
                                                                f301=f301+1;
                                                        if(strstr(s,"6MR"))						//Thioamide(NH)-6-member-ring; 10.εZα@R6
                                                                f302=f302+1;
                                                        if(strstr(s,"7MR"))						//Thioamide(NH)-7-member-ring; 10.εZα@R7
                                                                f303=f303+1;
                                                }
						if(strstr(s,"DTD"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Di-thioamide(NH)-3/4-member-ring; 10.εεZ@R3/10.εεZ@R4
                                                                f304=f304+1;
                                                        if(strstr(s,"5MR"))						//Di-Thioamide(NH)-5-member-ring; 10.εεZ@R5
                                                                f305=f305+1;
                                                        if(strstr(s,"6MR"))						//Di-Thioamide(NH)-6-member-ring; 10.εεZ@R6
                                                                f306=f306+1;
                                                        if(strstr(s,"7MR"))						//Di-Thioamide(NH)-7-member-ring; 10.εεZ@R7
                                                                f307=f307+1;
                                                }
						if(strstr(s,"UER") && strstr(s,"AMDUER")==NULL && strstr(s,"UERAMD")==NULL && strstr(s,"UERNYL")==NULL && strstr(s,"NYLUER")==NULL && strstr(s,"MTDUER")==NULL && strstr(s,"UERMTD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Amidine(NH)-3/4-member-ring; 10.γZα@R3/10.γZα@R4
                                                                f308=f308+1;
                                                        if(strstr(s,"5MR"))						//Amidine(NH)-5-member-ring; 10.γZα@R5
                                                                f309=f309+1;
                                                        if(strstr(s,"6MR"))						//Amidine(NH)-6-member-ring; 10.γZα@R6
                                                                f310=f310+1;
                                                        if(strstr(s,"7MR"))						//Amidine(NH)-7-member-ring; 10.γZα@R7
                                                                f311=f311+1;
                                                }
						if(strstr(s,"DUR"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Di-amidine(NH)-3/4-member-ring; 10.γγZ@R3/10.γγZ@R4
                                                                f312=f312+1;
                                                        if(strstr(s,"5MR"))						//Di-amidine(NH)-5-member-ring; 10.γγZ@R5
                                                                f313=f313+1;
                                                        if(strstr(s,"6MR"))						//Di-amidine(NH)-6-member-ring; 10.γγZ@R6
                                                                f314=f314+1;
                                                        if(strstr(s,"7MR"))						//Di-amidine(NH)-7-member-ring; 10.γγZ@R7
                                                                f315=f315+1;
                                                }
						if(strstr(s,"NYL") && strstr(s,"AMDNYL")==NULL && strstr(s,"NYLAMD")==NULL && strstr(s,"UERNYL")==NULL && strstr(s,"NYLUER")==NULL && strstr(s,"MTDNYL")==NULL && strstr(s,"NYLMTD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                          //Amine-Conjugation-One-Vinyl-3/4-member-ring; 10.βZα@R3/10.βZα@R4
                                                                f416=f416+1;
                                                        if(strstr(s,"5MR"))                                             //Amine-Conjugation-One-Vinyl-5-member-ring; 10.βZα@R5
                                                                f417=f417+1;
                                                        if(strstr(s,"6MR"))                                             //Amine-Conjugation-One-Vinyl-6-member-ring; 10.βZα@R6
                                                                f418=f418+1;
                                                        if(strstr(s,"7MR"))                                             //Amine-Conjugation-One-Vinyl-7-member-ring; 10.βZα@R7
                                                                f419=f419+1;
                                                }
						if(strstr(s,"DYL"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                          //Amine-Conjugation-Two-Vinyl-3/4-member-ring; 10.ββZ@R3/10.ββZ@R4
                                                                f420=f420+1;
                                                        if(strstr(s,"5MR"))                                             //Amine-Conjugation-Two-Vinyl-5-member-ring; 10.ββZ@R5
                                                                f421=f421+1;
                                                        if(strstr(s,"6MR"))                                             //Amine-Conjugation-Two-Vinyl-6-member-ring; 10.ββZ@R6
                                                                f422=f422+1;
                                                        if(strstr(s,"7MR"))                                             //Amine-Conjugation-Two-Vinyl-7-member-ring; 10.ββZ@R7
                                                                f423=f423+1;
                                                }
					}
					if(strstr(s,"NH1")==NULL && strstr(s,"MR3")==NULL && strstr(s,"MR4")==NULL && strstr(s,"MR5")==NULL && strstr(s,"MR6")==NULL && strstr(s,"MR7")==NULL)
                                        {
                                                if(strstr(s,"AMD") && strstr(s,"AMDMTD")==NULL && strstr(s,"MTDAMD")==NULL && strstr(s,"AMDNYL")==NULL && strstr(s,"NYLAMD")==NULL && strstr(s,"AMDUER")==NULL && strstr(s,"UERAMD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Amide(N)-3/4-member-ring; 10.δα'α'@R3/10.δα'α'@R4
                                                                f316=f316+1;
                                                        if(strstr(s,"5MR"))						//Amide(N)-5-member-ring; 10.δα'α'@R5
                                                                f317=f317+1;
                                                        if(strstr(s,"6MR"))						//Amide(N)-6-member-ring; 10.δα'α'@R6
                                                                f318=f318+1;
                                                        if(strstr(s,"7MR"))						//Amide(N)-7-member-ring; 10.δα'α'@R7
                                                                f319=f319+1;
                                                }
                                                if(strstr(s,"DAM"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Di-Amide(N)-3/4-member-ring; 10.δδα'@R3/10.δδα'@R4
                                                                f320=f320+1;
                                                        if(strstr(s,"5MR"))						//Di-Amide(N)-5-member-ring; 10.δδα'@R5
                                                                f321=f321+1;
                                                        if(strstr(s,"6MR"))						//Di-Amide(N)-6-member-ring; 10.δδα'@R6
                                                                f322=f322+1;
                                                        if(strstr(s,"7MR"))						//Di-Amide(N)-7-member-ring; 10.δδα'@R7
                                                                f323=f323+1;
                                                }
                                                if(strstr(s,"MTD") && strstr(s,"AMDMTD")==NULL && strstr(s,"MTDAMD")==NULL && strstr(s,"MTDNYL")==NULL && strstr(s,"NYLMTD")==NULL && strstr(s,"MTDUER")==NULL && strstr(s,"UERMTD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Thioamide(N)-3/4-member-ring; 10.εα'α'@R3/10.εα'α'@R4
                                                                f324=f324+1;
                                                        if(strstr(s,"5MR"))						//Thioamide(N)-5-member-ring; 10.εα'α'@R5
                                                                f325=f325+1;
                                                        if(strstr(s,"6MR"))						//Thioamide(N)-6-member-ring;10.εα'α'@R6
                                                                f326=f326+1;
                                                        if(strstr(s,"7MR"))						//Thioamide(N)-7-member-ring; 10.εα'α'@R7
                                                                f327=f327+1;
                                                }
						if(strstr(s,"DTD"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Di-thioamide(N)-3/4-member-ring; 10.εεα'@R3/10.εεα'@R4
                                                                f328=f328+1;
                                                        if(strstr(s,"5MR"))						//Di-Thioamide(N)-5-member-ring; 10.εεα'@R5
                                                                f329=f329+1;
                                                        if(strstr(s,"6MR"))						//Di-Thioamide(N)-6-member-ring; 10.εεα'@R6
                                                                f330=f330+1;
                                                        if(strstr(s,"7MR"))						//Di-Thioamide(N)-7-member-ring; 10.εεα'@R7
                                                                f331=f331+1;
                                                }
                                                if(strstr(s,"UER") && strstr(s,"AMDUER")==NULL && strstr(s,"UERAMD")==NULL && strstr(s,"UERNYL")==NULL && strstr(s,"NYLUER")==NULL && strstr(s,"MTDUER")==NULL && strstr(s,"UERMTD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Amidine(N)-3/4-member-ring; 10.γα'α'@R3/10.γα'α'@R4
                                                                f332=f332+1;
                                                        if(strstr(s,"5MR"))						//Amidine(N)-5-member-ring; 10.γα'α'@R5
                                                                f333=f333+1;
                                                        if(strstr(s,"6MR"))						//Amidine(N)-6-member-ring; 10.γα'α'@R6
                                                                f334=f334+1;
                                                        if(strstr(s,"7MR"))						//Amidine(N)-7-member-ring; 10.γα'α'@R7
                                                                f335=f335+1;
                                                }
                                                if(strstr(s,"DUR"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))				//Di-amidine(N)-3/4-member-ring; 10.γγα'@R3/10.γγα'@R4
                                                                f336=f336+1;
                                                        if(strstr(s,"5MR"))						//Di-amidine(N)-5-member-ring; 10.γγα'@R5
                                                                f337=f337+1;
                                                        if(strstr(s,"6MR"))						//Di-amidine(N)-6-member-ring; 10.γγα'@R6
                                                                f338=f338+1;
                                                        if(strstr(s,"7MR"))						//Di-amidine(N)-7-member-ring; 10.γγα'@R7
                                                                f339=f339+1;
                                                }
						if(strstr(s,"NYL") && strstr(s,"AMDNYL")==NULL && strstr(s,"NYLAMD")==NULL && strstr(s,"UERNYL")==NULL && strstr(s,"NYLUER")==NULL && strstr(s,"MTDNYL")==NULL && strstr(s,"NYLMTD")==NULL)
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                          //Amine-Conjugation-One-Vinyl-3/4-member-ring; 10.βα'α'@R3/10.βα'α'@R4
                                                                f424=f424+1;
                                                        if(strstr(s,"5MR"))                                             //Amine-Conjugation-One-Vinyl-5-member-ring; 10.βα'α'@R5
                                                                f425=f425+1;
                                                        if(strstr(s,"6MR"))                                             //Amine-Conjugation-One-Vinyl-6-member-ring; 10.βα'α'@R6
                                                                f426=f426+1;
                                                        if(strstr(s,"7MR"))                                             //Amine-Conjugation-One-Vinyl-7-member-ring; 10.βα'α'@R7
                                                                f427=f427+1;
                                                }
                                                if(strstr(s,"DYL"))
                                                {
                                                        if(strstr(s,"3MR") || strstr(s,"4MR"))                          //Amine-Conjugation-Two-Vinyl-3/4-member-ring; 10.ββα'@R3/10.ββα'@R4
                                                                f428=f428+1;
                                                        if(strstr(s,"5MR"))                                             //Amine-Conjugation-Two-Vinyl-5-member-ring; 10.ββα'@R5
                                                                f429=f429+1;
                                                        if(strstr(s,"6MR"))                                             //Amine-Conjugation-Two-Vinyl-6-member-ring; 10.ββα'@R6
                                                                f430=f430+1;
                                                        if(strstr(s,"7MR"))                                             //Amine-Conjugation-Two-Vinyl-7-member-ring; 10.ββα'@R7
                                                                f431=f431+1;
                                                }
                                        }
				}
				...
				if(strncmp(s,"N", 1)==0 && strstr(s,"3MR")==NULL && strstr(s,"4MR")==NULL && strstr(s,"5MR")==NULL && strstr(s,"6MR")==NULL && strstr(s,"7MR")==NULL && strstr(s,"NH1")==NULL && strlen(s)>=9)
                        {
                                if(strstr(s,"NYLAMD")==NULL && strstr(s,"AMDNYL")==NULL && strstr(s,"NYLMTD")==NULL &&
                                   ...
                                   strstr(s,"UERAMD")==NULL && strstr(s,"UERMTD")==NULL && strstr(s,"MTDUER")==NULL)
                                {
                                        if(strstr(s,"NYL"))                                                             //Amine-Conjugation-One-Vinyl; 10.βα'α'@Rg7
                                                f432=f432+1;
                                        if(strstr(s,"DYL"))                                                             //Amine-Conjugation-Two-Vinyl; 10.ββα'@Rg7
                                                f433=f433+1;
                                        if(strstr(s,"AMD"))                                                             //Amide; 10.δα'α'@Rg7
                                                f343=f343+1;
                                        if(strstr(s,"DAM"))                                                             //Di-Amide; 10.δδα'@Rg7
                                                f344=f344+1;
                                        if(strstr(s,"MTD"))                                                             //Thioamide; 10.εα'α'@Rg7
                                                f345=f345+1;
                                        if(strstr(s,"DTD"))                                                             //Di-Thioamide; 10.εεα'@Rg7
                                                f346=f346+1;
                                        if(strstr(s,"UER"))                                                             //Amidine; 10.γα'α'@Rg7
                                                f347=f347+1;
                                        if(strstr(s,"DUR"))                                                             //Di-Amidine; 10.γγα'@Rg7
                                                f348=f348+1;
                                }
			}
				if(strncmp(s,"N", 1)==0 && strstr(s,"NH1")==NULL && strlen(s)>=15)
                        {
                                if(strstr(s,"NYLAMD") || strstr(s,"AMDNYL"))                                            //Amine-Conjugation-Amide-Vinyl; 10.βδα'@Rg7
                                        f434=f434+1;
                                if(strstr(s,"NYLMTD") || strstr(s,"MTDNYL"))                                            //Amine-Conjugation-Thioamide-Vinyl; 10.βεα'@Rg7
                                        f435=f435+1;
                                if(strstr(s,"NYLUER") || strstr(s,"UERNYL"))                                            //Amine-Conjugation-Imine-Vinyl; 10.βγα'@Rg7
                                        f436=f436+1;
                                if(strstr(s,"AMDMTD") || strstr(s,"MTDAMD"))                                            //Amine-Conjugation-Amide-Thioamide; 10.δεα'@Rg7
                                        f437=f437+1;
                                if(strstr(s,"AMDUER") || strstr(s,"UERAMD"))                                            //Amine-Conjugation-Amide-Imine; 10.δγα'@Rg7
                                        f438=f438+1;
                                if(strstr(s,"MTDUER") || strstr(s,"UERMTD"))                                            //Amine-Conjugation-Thioamide-Imine; 10.γεα'@Rg7
                                        f439=f439+1;
                        }
			if(strncmp(s,"N", 1)==0 && strstr(s,"NH1")==NULL)
			{
				if(strstr(s,"AMD") && strstr(s,"AMDMTD")==NULL && strstr(s,"MTDAMD")==NULL && strstr(s,"AMDNYL")==NULL && strstr(s,"NYLAMD")==NULL && strstr(s,"AMDUER")==NULL && strstr(s,"UERAMD")==NULL)
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))  
						f497=f497+1;  //Amide(N)-fused-3/4-member-ring; 10.δα'α'@R3_R/10.δα'α'@R4_R
					if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f498=f498+1; //Amide(N)-fused-5/6/7-member-ring; 10.δα'α'@R5_5/10.δα'α'@R6_6/10.δα'α'@R7_7/10.δα'α'@R5_6/10.δα'α'@R5_7/10.δα'α'@R6_7
				}

				if(strstr(s,"DAM"))
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f499=f499+1; //Diamide(N)-fused-3/4-member-ring; 10.δδα'@R3_R/10.δδα'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f500=f500+1; //Diamide(N)-fused-5/6/7-member-ring; 10.δδα'@R5_5/10.δδα'@R6_6/10.δδα'@R7_7/10.δδα'@R5_6/10.δδα'@R5_7/10.δδα'@R6_7
                                }

				if(strstr(s,"MTD") && strstr(s,"AMDMTD")==NULL && strstr(s,"MTDAMD")==NULL && strstr(s,"MTDNYL")==NULL && strstr(s,"NYLMTD")==NULL && strstr(s,"MTDUER")==NULL && strstr(s,"UERMTD")==NULL)
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f501=f501+1; //Thioamide(N)-fused-3/4-member-ring; 10.εα'α'@R3_R/10.εα'α'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f502=f502+1; //Thioamide(N)-fused-5/6/7-member-ring; 10.εα'α'@R5_5/10.εα'α'@R6_6/10.εα'α'@R7_7/10.εα'α'@R5_6/10.εα'α'@R5_7/10.εα'α'@R6_7
                                }

				if(strstr(s,"DTD"))
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f503=f503+1; //Dithioamide(N)-fused-3/4-member-ring; 10.εεα'@R3_R/10.εεα'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f504=f504+1; //Dithioamide(N)-fused-5/6/7-member-ring; 10.εεα'@R5_5/10.εεα'@R6_6/10.εεα'@R7_7/10.εεα'@R5_6/10.εεα'@R5_7/10.εεα'@R6_7
                                }

				if(strstr(s,"UER") && strstr(s,"AMDUER")==NULL && strstr(s,"UERAMD")==NULL && strstr(s,"UERNYL")==NULL && strstr(s,"NYLUER")==NULL && strstr(s,"MTDUER")==NULL && strstr(s,"UERMTD")==NULL)
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f505=f505+1; //Amidine(N)-fused-3/4-member-ring; 10.γα'α'@R3_R/10.γα'α'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f506=f506+1; //Amidine(N)-fused-5/6/7-member-ring; 10.γα'α'@R5_5/10.γα'α'@R6_6/10.γα'α'@R7_7/10.γα'α'@R5_6/10.γα'α'@R5_7/10.γα'α'@R6_7
                                }

				if(strstr(s,"DUR"))
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f507=f507+1; //Urea(N)-fused-3/4-member-ring; 10.γγα'@R3_R/10.γγα'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f508=f508+1; //Urea(N)-fused-5/6/7-member-ring; 10.γγα'@R5_5/10.γγα'@R6_6/10.γγα'@R7_7/10.γγα'@R5_6/10.γγα'@R5_7/10.γγα'@R6_7
                                }

				if(strstr(s,"NYL") && strstr(s,"AMDNYL")==NULL && strstr(s,"NYLAMD")==NULL && strstr(s,"UERNYL")==NULL && strstr(s,"NYLUER")==NULL && strstr(s,"MTDNYL")==NULL && strstr(s,"NYLMTD")==NULL)
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f509=f509+1; //VinylAmine(N)-fused-3/4-member-ring; 10.βα'α'@R3_R/10.βα'α'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f510=f510+1; //VinylAmine(N)-fused-5/6/7-member-ring; 10.βα'α'@R5_5/10.βα'α'@R6_6/10.βα'α'@R7_7/10.βα'α'@R5_6/10.βα'α'@R5_7/10.βα'α'@R6_7
                                }

				if(strstr(s,"DYL"))
				{
					if(strstr(s,"MR3") || strstr(s,"MR4") || strstr(s,"3MR5") || strstr(s,"3MR6") || strstr(s,"3MR7") || strstr(s,"4MR5") || strstr(s,"4MR6") || strstr(s,"4MR7"))
                                                f511=f511+1; //Di-vinylAmine(N)-fused-3/4-member-ring; 10.ββα'@R3_R/10.ββα'@R4_R
                                        if((strstr(s,"MR5") || strstr(s,"MR6") || strstr(s,"MR7")) && strstr(s,"3MR5")==NULL && strstr(s,"3MR6")==NULL && strstr(s,"3MR7")==NULL && strstr(s,"4MR5")==NULL && strstr(s,"4MR6")==NULL && strstr(s,"4MR7")==NULL)
                                                f512=f512+1; //Di-vinylAmine(N)-fused-5/6/7-member-ring; 10.ββα'@R5_5/10.ββα'@R6_6/10.ββα'@R7_7/10.ββα'@R5_6/10.ββα'@R5_7/10.ββα'@R6_7
                                }
			}


			if(strncmp(s,"O",1)==0 && strstr(s,"DST") && strstr(s, "3MR")==NULL && strstr(s, "4MR")==NULL && strstr(s, "5MR")==NULL && strstr(s, "6MR")==NULL) //O=C-O-C=O; 14.δδ@Rg6
				f349=f349+1;
			if(strncmp(s,"O",1)==0 && strstr(s,"ODD")) //S=C-O-C=S; 14.εε
                                f350=f350+1;
			if(strncmp(s,"O",1)==0 && strstr(s,"DON"))                                                //O=C-O-C=N; 14.γδ
                                f351=f351+1;
			if(strncmp(s,"O",1)==0 && strstr(s,"OTD")) //S=C-O-C; 14.εE
				f410=f410+1;
			...
			if(strncmp(s,"N",1)==0 && strstr(s,"6MR"))
			{
			   if(strstr(s,"NC4NC4NH1") || strstr(s,"NC4NH1NC4") || strstr(s,"NH1NC4NC4") || strstr(s,"NC4NC4NC1") || strstr(s,"NC4NC1NC4") || strstr(s,"NC4NC4NO1") || strstr(s,"NC4NO1NC4") ||
				...
				f480=f480+1;		//Pyridinium-N; 11.ωωα(!Q!X)@R6
			...
			if(strstr(s,"4MR4MR4MR") && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strchr(st3,'4')==NULL) //Cubane; 32@R4_4_4
				f487=f487+1;
			if(strstr(s,"6MR6MR6MR") && strchr(s,'4')==NULL)					//Fused-6-6-6; 32(!ω)@R6_6_6
                                f488=f488+1;
			//if(strstr(s,"6MR6MR6MR") && strchr(st1,'4') && strchr(st2,'4') && strchr(st3,'4')) //Fused-6-6-6-Aromatic; 33@R6_6_6
                        //        f489=f489+1;
			if(strstr(s,"6MR6MR") && strstr(s,"5MR") && strchr(s,'4')==NULL)		   //Fused-6-6-5; 32(!ω)@R6_6_5
				f489=f489+1;
			if(strstr(s,"6MR5MR6MR") && strchr(s,'4')==NULL)				   //Fused-6-6-5; 32(!ω)@R6_6_5
                                f489=f489+1;
			if(strstr(s,"5MR5MR") && strstr(s,"6MR") && strchr(s,'4')==NULL)		   //Fused-5-5-6; 32(!ω)@R5_5_6
                                f490=f490+1;
			if(strstr(s,"5MR6MR5MR") && strchr(s,'4')==NULL)				   //Fused-5-5-6; 32(!ω)@R5_5_6
                                f490=f490+1;
			if(strstr(s,"5MR") && strstr(s,"6MR") && strstr(s,"7MR") && strchr(s,'4')==NULL)   //Fused-5-6-7; 32(!ω)@R5_6_7
				f491=f491+1;
			if(strstr(s,"6MR6MR") && strstr(s,"7MR") && strchr(s,'4')==NULL)		   //Fused-6-6-7; 32(!ω)@R6_6_7
                                f492=f492+1;
                        if(strstr(s,"6MR7MR6MR") && strchr(s,'4')==NULL)				   //Fused-6-6-7; 32(!ω)@R6_6_7
                                f492=f492+1;
			if(strstr(s,"5MR5MR") && strstr(s,"7MR") && strchr(s,'4')==NULL)		   //Fused-5-5-7; 32(!ω)@R5_5_7
                                f493=f493+1;
                        if(strstr(s,"5MR7MR5MR") && strchr(s,'4')==NULL)				   //Fused-5-5-7; 32(!ω)@R5_5_7
                                f493=f493+1;
			if(strstr(s,"5MR5MR5MR") && strchr(s,'4')==NULL)            			   //Fused-5-5-5; 32(!ω)@R5_5_5
                                f494=f494+1;
			if(strstr(s,"6MR4MR") || strstr(s,"4MR6MR") || strstr(s,"6MR3MR") || strstr(s,"3MR6MR"))
			{
				...
				f495=f495+1;								//Fused 6-3 or 6-4 rings; 32(!ω)@R6_3/32(!ω)@R6_4
			}
			if(strstr(s,"5MR3MR") || strstr(s,"3MR5MR") || strstr(s,"5MR4MR") || strstr(s,"4MR5MR"))
			{
				if(strstr(s,"5MR4MR3")==NULL && strstr(s,"5MR4MR4")==NULL && strstr(s,"5MR4MR5")==NULL &&
				   ...
				   strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strchr(st3,'4')==NULL)
                                f496=f496+1;								//Fused 5-3 or 5-4 rings; 32(!ω)@R5_3/32(!ω)@R5_4
			}

			//if(strstr(s,"4MR4MR") && strstr(s,"5MR") && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strchr(st3,'4')==NULL)  //Fused-4-4-5; 32(!ω)@R4_4_5
                        //        f496=f496+1;
                        //if(strstr(s,"4MR5MR4MR") && strchr(st1,'4')==NULL && strchr(st2,'4')==NULL && strchr(st3,'4')==NULL)                  //Fused-4-4-5; 32(!ω)@R4_4_5
                        //        f496=f496+1;
