...
main(int argc, char *argv[])
{
	...
	printf("               <Input file-1>         <Output file>\n");
  	printf("./logp_mr_calc_7.exe <Output file of logp_mr_calc_6.exe> <Output file name>\n");
  	exit(1);
	}
	...
	if (fw==NULL)            
        {
        printf("logp_mr_calc_7.exe: Cannot write output. No output file name is given\n");
        exit(1);
        }
	int line=0;
