...
inline void Point_3d::rotate(double *b,double *c,double *d,double an){
	int i;
	double b1[3],c1[3],d1[3];
	//double pt_b[3],pt_c[3],pt_d[3];
	double rc,rc1,rd,rd1;
	double cos_c1_x,cos_c1_xy,sin_c1_x,sin_c1_xy;
	double cos_d1_x,cos_d1_xy,sin_d1_x,sin_d1_xy;
	double c_x1,c_x,c_y,c_z;
...
//		sin_c1_x= 1/sqrt(2);
	...
	cos_c1_xy = rc1/rc;
	sin_c1_xy = c1[2]/rc;
	rd = sqrt((d1[0] * d1[0]) + (d1[1] * d1[1]) + (d1[2] * d1[2]));
	rd1 = sqrt((d1[0] * d1[0]) + (d1[1] * d1[1]));
	if(rd1==0){
	//	cos_d1_x = 1/sqrt(2);
	//	sin_d1_x = 1/sqrt(2);
		cos_d1_x = 1;
	...
	cos_d1_xy = rd1/rd;
	sin_d1_xy = d1[2]/rd;
	c_x1 = c1[1] * sin_c1_x + c1[0] * cos_c1_x;
	c_y = c1[1] * cos_c1_x - c1[0] * sin_c1_x;
	c_x = c1[2] * sin_c1_xy + c_x1 * cos_c1_xy;
	c_z = c1[2] * cos_c1_xy - c_x1 * sin_c1_xy;
