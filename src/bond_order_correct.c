...
int main(int argc, char *argv[])
	...
	if (argc<2) 
	  {
          printf("./bond_order_correct.exe               				<Input file>\n");
	  printf("./bond_order_correct.exe <A concatenate bond order printed by bond_order_CM.exe, bond_order_sdf.exe and bond_order_calc.exe programmes>\n");
	  exit(1);
	  }
